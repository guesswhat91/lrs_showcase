...
AND kvi_cases > measure_direct_hrs
...
, (prcnt_of_emp_2020_A - prcnt_of_emp_2019_A)/ prcnt_of_emp_2020_A prcnt_chng_over_365_days
...
WHERE a.fisc_mth_of_yr BETWEEN '04' AND '12' 
